...
import { OpenTokSDK } from 'opentok-accelerator-core'; // GilK
import { Button } from 'react-materialize';

// didn't work w .env, so using credentials.json for now, GilK
import credentials from './credentials.json';

// import './App.css'; from tokbox sample code, GilK
...
//   "sessionId": process.env.REACT_SESSIONID,
...
const startCallMask = start =>
  <div className="App-mask">
    <div className="message button clickable" onClick={start}>
      <Button>
